...
class AhpHierRU
{
    ...
    "hLmtLv"		=>	"лишком много уровней иерархии. ",
    ...
    "hColSemi"	    =>	"еравное количество <i>двоеточий</i> и <i>точек с запятой</i>, проверьте определение иерархии",
    "hHier"			=>	"шибка в иерархии, пожалуйста, проверьте текст. ",
    ...
    "aTblTh"		=>	"<th>Нет</th><th>Узел</th><th>Критерий</th><th>Глб Приор.</th><th>Сравнить</th>",
